...
import { Bookmark, SlidersHorizontal, Search, Users, MessageSquare, Target } from 'lucide-react';
import { useCandidates } from '../../hooks/useSupabase';
...
export default function EmployerCandidates() {
    ...
    const [breakdown, setBreakdown] = useState<Candidate | null>(null);
    ...
    const filtered = useMemo(() => {
        ...
        return candidates.filter(c =>
            ...
            c.match_score >= minMatch &&
            (!showSavedOnly || savedIds.has(c.id))
        );
    }, [candidates, search, minMatch, showSavedOnly, savedIds]);
    ...
    return (
        ...
        <EmployerLayout>
            <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    {(search || minMatch > 0) && (
                        <p className="text-xs text-muted-foreground">{filtered.length} candidate{filtered.length !== 1 ? 's' : ''} found</p>
                    )}
                </div>
                                ...
                                <CardContent className="p-5 flex flex-col flex-1">
                                    ...
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <div className="flex flex-col items-end gap-1.5 shrink-0">
                                            <span className={`text-xs font-semibold px-2.5 py-1 rounded-full border ${scoreStyle(candidate.match_score)}`}>
                                    ...
                                    <div className="mt-auto flex gap-2">
                                        ...
                                        <Button
                                            ...
                                            onClick={() => setBreakdown(candidate)}
                                        >
        ...
        {breakdown && (
            <MatchBreakdownModal
                ...
                candidateName={breakdown.full_name}
                jobTitle={breakdown.best_job_title}
                details={breakdown.match_details || []}
            />
        )}
